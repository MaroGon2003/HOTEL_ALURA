...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		String numReserva = String.valueOf(idReserva);
	...
	private void guardarHuesped() {
		...
		if (txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {
			...
			Huesped huesped = new Huesped(txtNombre.getText(),txtApellido.getText(),fechaNacimiento,txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(),numReserva);
